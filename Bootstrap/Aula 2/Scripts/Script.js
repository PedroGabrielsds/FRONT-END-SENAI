    ...
    document.querySelector(".Catalogo").innerHTML += `
        <div class="card" style="width: 23rem;">
            ...
            <div class="card-body">
                ...
                <p class="card-text" id="Descricao">${cadaPacote.descricao}</p>
                <p class="card-text" id="Preço">${cadaPacote.preco}</p>
                <button class="BtnVM" type="button">Ver mais</button>
            </div>
        </div>
